...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppModulesHomeDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function DashboardComponent_div_100_tr_14_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr");
    ...
    function DashboardComponent_div_100_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](7, "Id dell' Ordine");
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](13, "Quantit\xE0");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](14, DashboardComponent_div_100_tr_14_Template, 9, 4, "tr", 20);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](15, "button", 50);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DashboardComponent_div_100_Template_button_click_15_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r25);

          var ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r24.closeTransaction();
        });

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](16, "CHIUDI");
        ...
        value: function cancelStrategy(orderId, pair, name) {
          ...
          if (orderId !== undefined) {
            this.actionService.stopStrategy(orderId, pair).subscribe(function (resp) {
              _this6.actionService.deleteFromDb(name).subscribe(function () {
                _this6.closeCancel();

                _this6.loadActiveStrategy();

                _this6.actionService.getBtcBalance().subscribe();

                _this6.alertService.addMessage('success', 'Ordine cancellato con successo');
              });
            });
          } else {
            this.closeCancel();
    ...
    DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function DashboardComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](100, DashboardComponent_div_100_Template, 17, 2, "div", 36);
      ...
      _createClass(StrategiesComponent, [{
        ...
        value: function loadPairs() {
          ...
          this.actionService.getAllPairs().subscribe(function (resp) {
            _this9.pairs = lodash__WEBPACK_IMPORTED_MODULE_3__["filter"](resp, function (o) {
        ...
        value: function initializeStrategy() {
          ...
          this.actionService.setStrategy(payload).subscribe(function (resp) {
            if (resp) {
              ...
              _this10.alertService.addMessage('success', 'Strategia inizializzata con successo');
            }
          }, function (error) {
            _this10.close();
          });
      ...
      _createClass(AlertComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.alertService.getMessage().subscribe(function (alert) {
            ...
            $(_this11.el.nativeElement).append(currentAlert);
            setTimeout(function () {
        ...
        value: function intercept(request, next) {
          ...
          return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
            if (err.status === 401) {
              ...
              _this12.authService.logout();
            }

            var error = err.error;

            _this12.alert.addMessage('danger', error.error);
