      ...
      _createClass(DashboardComponent, [{
        ...
        value: function calculateCapital(type) {
          ...
          switch (type) {
            ...
            case 'current':
              lodash__WEBPACK_IMPORTED_MODULE_1__["forEach"](this.activeStrategies, function (str) {
                realCurrentCapital += parseFloat(_this16.calculateCurrentCapital(str.current_capital, str.coin_pair));
              });
      ...
      _createClass(StrategiesComponent, [{
          ...
          if (name !== '' && this.strategyType === 'single') {
            this.actionService.checkStrategy(name).subscribe(function (resp) {
              if (lodash__WEBPACK_IMPORTED_MODULE_3__["isString"](resp.success)) {
                _this18.isStrPresent = false;
              } else {
                _this18.isStrPresent = true;

                _this18.alertService.addMessage('danger', 'Nome strategia presente');
              }

              return _this18.isStrPresent;
            }, function (error) {});
          }
        }
      }, {
        ...
        value: function loadPairs() {
          ...
          this.actionService.getAllPairs().subscribe(function (resp) {
            if (_this19.formValue.strategy_pairs_size.value === 0) {
              var result;
              result = lodash__WEBPACK_IMPORTED_MODULE_3__["filter"](resp, function (o) {
                return o.price <= 0.000002;
              });
              _this19.pairs = [];
              lodash__WEBPACK_IMPORTED_MODULE_3__["forEach"](_this19.activeList, function (o) {
                lodash__WEBPACK_IMPORTED_MODULE_3__["forEach"](result, function (p) {
                  if (o.pair === p.name) {
                    _this19.pairs.push(p);
                  }
                });
              });

              _this19.formValue.strategy_pairs_size.setValue(200);

              _this19.strLength = _this19.pairs.length;
            } else {
              var value = _this19.formValue.strategy_pairs_size.value < 100 ? _this19.formValue.strategy_pairs_size.value < 10 ? '0.0000000' + _this19.formValue.strategy_pairs_size.value.toString() : '0.000000' + _this19.formValue.strategy_pairs_size.value.toString() : '0.00000' + _this19.formValue.strategy_pairs_size.value.toString();
              var result2;
        ...
        value: function initializeStrategy() {
          ...
          this.actionService.setStrategy(payload).subscribe(function (resp) {
            if (resp) {
              ...
              _this20.actionService.getBtcBalance().subscribe();

              _this20.alertService.addMessage('success', 'Strategia inizializzata con successo');
            }
          }, function (error) {
            _this20.close();
          });
        ...
        value: function initializeStrategies() {
          ...
          this.actionService.setStrategies(payload).subscribe(function (resp) {
            if (resp) {
              ...
              _this21.alertService.addMessage('success', resp.success);
            }
          }, function (error) {
            _this21.close();

            _this21.alertService.addMessage('danger', error.error);
          });
        }
      }, {
        key: "editStrategy",
      ...
      _createClass(AlertComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.alertService.getMessage().subscribe(function (alert) {
            ...
            $(_this22.el.nativeElement).append(currentAlert);
            setTimeout(function () {
        ...
        value: function intercept(request, next) {
          ...
          return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(function (err) {
            if (err.status === 401) {
              ...
              _this23.authService.logout();
            }

            var error = err.error;

            _this23.alert.addMessage('danger', error.error);
