...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppModulesHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(authService, actionService, router) {
        ...
        this.user = this.authService.user; // document.addEventListener("visibilitychange", () => {
  ...
  function srcEnvironmentsEnvironmentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var environment = {
      ...
      api: 'http://ec2-15-161-232-210.eu-south-1.compute.amazonaws.com:3000/' // api: 'http://ec2-15-160-23-179.eu-south-1.compute.amazonaws.com:3000/' -- MarcoP
